<%@ Page Title="" Language="C#" MasterPageFile="~/SistemaMaster.Master" AutoEventWireup="true" CodeBehind="AlterarVenda.aspx.cs" Inherits="Sistemaloja.AlterarVenda" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h1 class="titulo">Alterar Venda</h1><br />
...
<asp:Label ID="Label5" runat="server"></asp:Label>
    ...
    <table>
        <caption>Atualização da venda</caption>
    ...
    <tr><td> <asp:Label ID="Label2" runat="server" Text="Cliente:" Font-Bold="True" Font-Names="Segoe UI" ForeColor="Black"></asp:Label></td><td>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:aspnetdbConnectionString %>" SelectCommand="SELECT [idCliente], [nome] FROM [Cliente]"></asp:SqlDataSource>
        <br /></td></tr>
