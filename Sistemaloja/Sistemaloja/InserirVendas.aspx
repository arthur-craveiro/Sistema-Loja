<%@ Page Title="" Language="C#" MasterPageFile="~/SistemaMaster.Master" AutoEventWireup="true" CodeBehind="InserirVendas.aspx.cs" Inherits="Sistemaloja.InserirVendas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h1 class="titulo">Inserir Venda</h1><br />
...
<asp:Label ID="Label5" runat="server"></asp:Label>
    ...
    <table>
        <caption>Cadastro de nova venda</caption>
    ...
    <tr><td> <asp:Label ID="Label2" runat="server" Text="Cliente:" Font-Bold="True" Font-Names="Segoe UI" ForeColor="Black"></asp:Label></td><td>
        <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource1" DataTextField="nome" DataValueField="idCliente">
        </asp:DropDownList>
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:aspnetdbConnectionString %>" SelectCommand="SELECT [nome], [idCliente] FROM [Cliente]"></asp:SqlDataSource>
        <br /></td></tr>
