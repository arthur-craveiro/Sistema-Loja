...
namespace Sistemaloja
{
    public partial class InserirVendas : System.Web.UI.Page
    {
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            {
                Label5.Text = "Por favor, envie a venda antes de incluir itens nela.";
            }
        }
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                DAL.DALVenda dalVenda = new DAL.DALVenda();
                Modelo.Venda venda = new Modelo.Venda(Convert.ToDateTime(Calendar1.SelectedDate), double.Parse(TextBox3.Text), double.Parse(Label6.Text), int.Parse(DropDownList1.SelectedValue));
                dalVenda.InserirVendas(venda);
                int j = dalVenda.ultId();
                Response.Redirect("./InserirVendas.aspx?idVenda=" + dalVenda.ultId());
            }
            else
            {
                DAL.DALVenda dalVenda = new DAL.DALVenda();
