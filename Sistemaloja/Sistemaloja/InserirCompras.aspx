...
<asp:Label ID="Label5" runat="server"></asp:Label>
    ...
    <tr><td> <asp:Label ID="Label2" runat="server" Text="Fornecedor:" Font-Bold="True" Font-Names="Segoe UI" ForeColor="Black"></asp:Label></td><td>
     ...
     <tr><td><asp:Label ID="Label4" runat="server" Text="Valor Total:" Font-Bold="True" Font-Names="Segoe UI" ForeColor="Black"></asp:Label></td><td><asp:TextBox ID="TextBox4" runat="server"></asp:TextBox><br /></td></tr>
