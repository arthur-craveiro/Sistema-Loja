<%@ Page Title="" Language="C#" MasterPageFile="~/SistemaMaster.Master" AutoEventWireup="true" CodeBehind="InserirItensVenda.aspx.cs" Inherits="Sistemaloja.InserirItensVenda" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr><td class="auto-style1"> <asp:Label ID="Label2" runat="server" Text="Peso:" Font-Bold="True" Font-Names="Segoe UI" ForeColor="Black"></asp:Label></td><td class="auto-style1">
        <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
        <br /></td></tr>
     <tr><td><asp:Label ID="Label3" runat="server" Text="Preço/KG:" Font-Bold="True" Font-Names="Segoe UI" ForeColor="Black"></asp:Label></td><td><asp:TextBox ID="TextBox2" runat="server"></asp:TextBox><br /></td></tr>
